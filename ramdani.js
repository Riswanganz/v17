...
if (isBanned) return freply(mess.banned)
freply(mess.wait)
anu = await fetchJson(`https://api-ramdaniofficial-docs.herokuapp.com/api/nsfw/bdsm?apikey=Ramdaniofficial`)
oke = await getBuffer(anu.result)
Ramdani.sendMessage(from, oke, image, {quoted: mek, caption: '*Dosa tanggung sendiri nyet*'})
break
case 'neko':
...
if (isBanned) return freply(mess.banned)
freply(mess.wait)
anu = await fetchJson(`https://api-ramdaniofficial-docs.herokuapp.com/api/nsfw/neko?apikey=Ramdaniofficial`)
oke = await getBuffer(anu.result)
Ramdani.sendMessage(from, oke, image, {quoted: mek, caption: '*Dosa tanggung sendiri nyet*'})
break
case 'bdsm':
